...
<body>
	...
	<a href="#" class="logo">Portfolio.</a>
		<nav class="navbar">
			<a href="#home" style="--i:1" class="active" onclick="window.location.reload()">Home</a>
			<a href="#about" style="--i:2" onclick="window.location.reload()">About</a>
			<a href="#skills" style="--i:3" onclick="window.location.reload()">Skills</a>
			<a href="#contact" style="--i:4" onclick="window.location.reload()">Contact</a>
